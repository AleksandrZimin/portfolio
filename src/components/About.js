    ...
    <div className="about">
      ...
      <div className="about-text">
        ...
        <p className="about-text-item">
          <icon>👋</icon>Меня зовут Александр и я ведущий инженер-тестировщик,
          специализирующийся на обеспечении высокого качества и надежности веб
          приложений, а так же организацию работы всего отдела тестирования.
        </p>
        <p className="about-text-item">
